...
| 0.3.0 | `v0.3.0` | M3 | documented | All scopes + full config surface + `mru:status` |
| 0.4.0 | `v0.4.0` | M4 | documented | Border UI |
| 0.5.0 | `v0.5.0` | M5 | documented | External overlay protocol (optional) |
| 1.0.0 | `v1.0.0` | M6 | documented | Stable dispatcher names, config keys, snapshot/apply semantics |
