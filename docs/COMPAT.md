...
| 1.0.0 (pending tag) | `efb50993780079460b0cbed1363e2166a2de1d9f` | `v0.56.2` | hyprpm install smoke pending release tag (M6-T9) | hyprpm distribution via `hyprpm.toml`: `commit_pins` populated (Hyprland `efb5099` → plugin hash; plugin-side value provisional until the v1.0.0 tag per M6-T9), repository metadata + build stanza verified by a clean-checkout build (M6-T5, issue #47) |
