...
| 1.0.0 (pending tag) | `efb50993780079460b0cbed1363e2166a2de1d9f` | `v0.56.2` | hyprpm install smoke pending release tag (M6-T9); **stress smokes PASS 2026-09-19** (see §Stress evidence) | Single tested pin for 1.0 (Variant A): `hyprpm.toml` `commit_pins` = Hyprland `efb5099` → plugin = the tagged commit itself (PR merged → pin set to main HEAD → tag placed on it). Older untested multi-pin entries removed; repository metadata + build stanza verified by a clean-checkout build (M6-T5, issue #47) |
